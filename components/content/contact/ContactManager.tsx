        ...
        <div>
            <div className="bg-transparent backdrop-blur-md p-5 rounded-lg shadow-lg max-w-lg text-center">
                ...
                <div className='flex justify-center gap-5'>
                    <a className='flex flex-row gap-3 w-fit items-center hover:text-[#1971c2] duration-300' href='https://www.linkedin.com/in/adrian-wika/' target="_blank" rel="noopener noreferrer">
